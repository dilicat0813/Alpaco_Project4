...
```powershell
(base) C:\Users\daddy>conda create -n Dash_project python=3.10
...
```
(base) C:\Users\daddy>conda activate Dash_project
(Dash_project) C:\Users\daddy>
```

```
(Dash_project) C:\Users\daddy>conda install jupyterlab pandas
Collecting package metadata (current_repodata.json): done
Solving environment: done
...
``` 
(Dash_project) C:\Users\daddy>dir Project4_Dash
 C 드라이브의 볼륨에는 이름이 없습니다.
 볼륨 일련 번호: 1AFD-D176

 C:\Users\daddy\Project4_Dash 디렉터리
...
(Dash_project) C:\Users\daddy>
(Dash_project) C:\Users\daddy>jupyter-lab --no-browser Project4_Dash
